...
[HelpURL("https://nvjob.github.io/unity/nvjob-advanced-water-shaders")]
[AddComponentMenu("#NVJOB/Advanced Water Shaders")]
...
[ExecuteInEditMode]
public class AdvancedWaterShaders : MonoBehaviour
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void WaterWind()
    {
        ...
        {
            wVectorY = Quaternion.AngleAxis(Time.time * rotateSpeed, Vector3.forward) * Vector2.one * rotateDistance;
            ...
            waterMaterial.SetInt("_AWSAngleTes", 90);
        }
        else
        {
            if (windZone != null)
            {
                ...
                Vector3 windV = windQ * Vector3.up * -0.1f;
                wVectorY = windV * Time.time * rotateSpeed;
                waterMaterial.SetInt("_AWSAngleTes", -180);
            }
        }

        waterMaterial.SetVector("_AWSMovement", new Vector4(0, 0, wVectorY.x, wVectorY.y));
