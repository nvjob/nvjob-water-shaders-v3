...
Shader "#NVJOB/Advanced Water Shaders/Specular" {
...
[HideInInspector][HDR]_AlbedoColorUp("Albedo Color Up", Color) = (0.125,0.154,0.188,1)
[HideInInspector][HDR]_AlbedoColorDown("Albedo Color Down", Color) = (0.125,0.154,0.188,1)
...
[HideInInspector]_TessNoise1Octaves("Noise 1 Octaves", float) = 5
...
#pragma surface surf BlinnPhong alpha:fade exclude_path:prepass noshadowmask noshadow vertex:vert tessellate:tessWater
#pragma target 4.6
